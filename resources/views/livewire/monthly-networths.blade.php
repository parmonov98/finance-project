            ...
            <div class="row">
              <div class="col-6">
                <div class="form-group">
                  ...
                  <input wire:model.defer="date_mod" class="form-control" id="date-input" type="date" name="date-input"
                    placeholder="date">
              ...
              @foreach ($home_loan as $data)
                <td>
                  <button data-toggle="modal" data-toggle="modal" data-target="#updateHomeLoan"
                    ...
                    class="btn border btn-sm">${{ $data->formatNumber($data->end_balance) }}</button>
                  {{-- <a role="button"
