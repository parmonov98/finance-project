            ...
            <table class="table table-responsive" style=" white-space: nowrap;">
              ...
              <tr>
                ...
                <td>
                  ...
                  <button data-toggle="modal" data-toggle="modal" data-target="#updateHomeLoan" wire:click="$emitTo('home-loan-update-modal', 'edit', {{ $data['id'] }})" class="btn border btn-sm">
                    ${{ number_format($data['end_balance'], 2, '.', ',') }}
                  </button>
              ...
              <tr>
                ...
                <td>
                  ...
                  <button data-toggle="modal" data-toggle="modal" data-target="#updateInvestmentSuper" wire:click="$emitTo('investment-super-update-modal', 'edit', {{ $data['id'] }})" class="btn border btn-sm">
              ...
              <tr>
                ...
                <td>
                  ...
                  <button data-toggle="modal" data-toggle="modal" data-target="#updateMonthlyNetworthCash" wire:click="$emitTo('monthly-networth-cash-update-modal', 'edit', '{{ $data->id }}')" class="btn border btn-sm">
              ...
              <tr>
                ...
                <td>
                  {{-- {{ $data->total_invested ? '$ ' . $data->formatNumber($data->total_invested) : '' }}--}}
                  <button data-toggle="modal" data-toggle="modal" data-target="#updateInvestPersonal" wire:click="$emitTo('invest-personal-update-modal', 'edit', '{{ $data->id }}')" class="btn border btn-sm">
                    $ {{ $data->formatNumber($data->total_invested)  }}
                  </button>
                </td>
                @endforeach
              ...
              <tr>
                ...
                <td>
                  {{-- {{ $data->total_invested ? '$ ' . $data->formatNumber($data->total_invested) : '' }}--}}
                  <button data-toggle="modal" data-toggle="modal" data-target="#updateLongTermInvestment" wire:click="$emitTo('long-term-investment-update-modal', 'edit', '{{ $data->id }}')" class="btn border btn-sm">
                    $ {{ $data->formatNumber($data->total_invested)  }}
                  </button>
                </td>
                @endforeach
              ...
              <tr>
                ...
                <td>
                  <button data-toggle="modal" data-toggle="modal" data-target="#updateMonthlyNetworthOtherInvestment" wire:click="$emitTo('monthly-networth-other-investment-update-modal', 'edit', '{{ $data->id }}')" class="btn border btn-sm">
