<div class="">
    ...
    <div class="modal {{ $is_open ? 'show ' : '' }} fade" id="updateInvestPersonal" tabindex="-1"
         style="{{ $is_open ? 'display:block;' : 'display:none;' }}" aria-labelledby="updateInvestPersonal"
         aria-hidden="true">
        <div class="modal-dialog modal-content">
            <form class="edit_invest_personal_form " wire:submit.prevent="save">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Invest Personal</h5>
