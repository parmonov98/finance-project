<div class="">
    ...
    <div class="modal {{ $is_open ? 'show ' : '' }} fade" id="updateLongTermInvestment" tabindex="-1"
         style="{{ $is_open ? 'display:block;' : 'display:none;' }}" aria-labelledby="updateLongTermInvestment"
         aria-hidden="true">
